...
repl = [
    ...
    (r"internal\.ToolDir", "workspace.ToolDir"),
    (r"internal\.ToolNameBenchstat", "workspace.ToolNameBenchstat"),
    (r"internal\.ToolNameQcachegrind", "workspace.ToolNameQcachegrind"),
    (r"internal\.ToolsResultsSuffix", "workspace.ToolsResultsSuffix"),
    ...
    (r"internal\.REGRESSION", "tracker.ChangeRegression"),
    (r"internal\.IMPROVEMENT", "tracker.ChangeImprovement"),
    (r"internal\.STABLE", "tracker.ChangeStable"),
