// Package app defines the CLI composition root ([Services]): inject interfaces to swap benchmark,
// collector, tracker, tools, or setup without changing cobra command wiring.
//
